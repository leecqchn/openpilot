...
extern real32_T look1_iflf_binlcpw(real32_T u0, const real32_T bp0[], const
  real32_T table[], uint32_T maxIndex);
extern void app_Chart3_Init(boolean_T *rty_is_steerLampOn_bl, DW_Chart3_app_T
  *localDW);
...
extern void app_Chart4_Init(boolean_T *rty_out_cond, DW_Chart4_app_T *localDW);
...
extern void app_Chart1_Init(uint8_T *rty_out_cond);
...
extern void app_Chart_o_Init(real32_T *rty_ramp_cof, DW_Chart_app_go_T *localDW);
